...
* For the extra credit, I added a red _Sign Out_ button on the chat nav bar. The button will only show up if a user is logged in. I did not do the other part of the extra credit where it is asking to save messages to firebase database.
